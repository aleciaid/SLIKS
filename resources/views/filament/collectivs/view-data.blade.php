<div class="space-y-6">
    <div class="grid gap-4 sm:grid-cols-2">
        ...
        <div class="rounded-xl border border-gray-200 p-4 dark:border-gray-700">
            ...
            <p class="mt-1 text-sm font-semibold text-gray-950 dark:text-white">{{ \App\Models\Collectiv::statusOptions()[$record->effective_status] ?? $record->effective_status }}</p>
        </div>
    </div>
    ...
    <div class="rounded-xl border border-gray-200 p-4 dark:border-gray-700">
        <div class="mb-3 flex items-center justify-between gap-3">
            ...
            <a href="{{ route('admin.collectiv.ktp.show', ['collectiv' => $record, 'download' => 1]) }}" class="text-sm font-semibold text-primary-600 hover:text-primary-500">
                Download
            </a>
        </div>

        <img src="{{ route('admin.collectiv.ktp.show', $record) }}" alt="KTP {{ $record->nama }}" class="max-h-[420px] w-full rounded-lg border border-gray-200 object-contain dark:border-gray-700">
    </div>
</div>
